...
import pic from '../../public/logoimg.avif'
   ...
   <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 bg-white'>
        <div className='flex justify-between items-center h-16'>
            <div className='flex space-x-2'>
                <img src={pic} className='h-13 w-12 rounded-full' alt="" />
                <h1 className='font-semibold text-xl cursor-pointer'>Ans<span className='text-green-500'>h</span>
